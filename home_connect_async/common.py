...
class HomeConnectError(Exception):
    ...
    def __init__(
        self, msg: str = None, code: int = None, response=None, inner_exception=None
    ):
        self.msg: str = msg
        self.code: int = code
        ...
        super().__init__(
            msg, code, self.error_key, self.error_description, inner_exception
        )
